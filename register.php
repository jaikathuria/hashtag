...
<html lang="en">
    ...
    <body>
                ...
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    ...
                    <div class="block block-themed animated fadeIn">
                        ...
                        <div class="block-content block-content-full block-content-narrow">
                            <!-- Register Title -->
                            <h1 class="h2 font-w600 push-30-t push-5 text-left">Skyer Hashtag</h1>
                            ...
                            <form class="js-validation-register form-horizontal push-50-t push-50" action="reg_process.php" method="post">
                               <div class="form-group error" id="unsuccess">
                                    ...
                                    <div class="col-xs-12 col-sm-8 col-md-8">
                                        <a  class="btn btn-block btn-danger">Registration Unsuccessful</a>
                                    </div>
                                </div>
                                <div class="form-group error" id="uae">
                                    <div class="col-sm-2 col-md-2 "></div>
                                    <div class="col-xs-12 col-sm-8 col-md-8">
                                        <a  class="btn btn-block btn-danger">Username already exist</a>
                                    </div>
                                </div>
       ...
       <div class="push-10-t text-center animated fadeInUp">
            <small class="text-muted font-w600"> &copy; Skyer Hashtag v1.0</small>
        </div>
