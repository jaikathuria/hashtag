                                        ...
                                        <table class="js-table-checkable table table-hover table-vcenter">
                                            <tbody>
                                               ...
                                               <?php
                                                    ...
                                                    $query = "SELECT * FROM message WHERE fr0m = '$name' ORDER BY sno DESC";
                                                    $result = mysqli_query($con,$query);
                                                    while($row = mysqli_fetch_object($result)){
                                                        echo "<tr><td class='font-w600' style='width: 140px;'>".$row->t0."</td><td><div class='text-muted push-5-t'>".$row->message."</div></td></tr>";
